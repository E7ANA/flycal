...
const GLOBAL_PRINCIPLES: BrainPrinciple[] = [
  ...
  },
  {
    ...
    description:
      "מגביל את מספר ימי ההוראה של כל מורה לפי היקף השעות הפרונטליות השבועיות שלו. הכלל מבוסס על טבלת עוז לתמורה. אם למורה יש אילוץ יום חופשי (MIN_FREE_DAYS), הוא תמיד גובר — מספר הימים יוגבל למינימום בין הכלל לבין (סה\"כ ימים - ימים חופשיים).",
    category: "global",
    details: [
      "אילוץ קשה (HARD)",
      "1-12 שעות (עד 50% משרה) → 3 ימים",
      "13-18 שעות (51%-75% משרה) → 4 ימים",
      "19-24+ שעות (76%-100%+ משרה) → 5 ימים",
...
const HOMEROOM_PRINCIPLE: BrainPrinciple = {
  id: "homeroom-early",
  name: "מחנכת בתחילת היום",
  description:
    "שעות שבהן המחנכת מלמדת את הכיתה שלה יועדפו בשעות הראשונות של היום. שעה 1-2 ללא עונש, מהשעה השלישית העונש גדל.",
  category: "homeroom",
  details: ["משקל: 75", "שעה 1-2: ללא עונש", "שעה 3+: עונש גדל"],
};
