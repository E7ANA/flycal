...
const GLOBAL_PRINCIPLES: BrainPrinciple[] = [
  ...
  {
    id: "daily-core-subjects",
    name: "מקצועות ליבה בכל יום",
    description:
      "אפשר להגדיר לכל שכבה רשימת מקצועות ליבה — כל כיתה בשכבה תחויב לקיים בכל יום לפחות שיעור אחד מאחד המקצועות הברשימה. מוגדר בדף הכיתות, כפתור 'מקצועות ליבה' ליד כל שכבה.",
    category: "global",
    details: [
      "ניתן להגדרה פר-שכבה (או פר-כיתה)",
      "אפשר לבחור כל מקצוע כ'ליבה' (לא רק אנגלית/מתמטיקה)",
      "ניתן ל-HARD (חובה) או ל-SOFT (העדפה)",
      "פעיל רק כאשר האילוץ מוגדר — לא אוטומטי",
    ],
    isHard: false,
  },
  {
